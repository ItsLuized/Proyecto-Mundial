...
import clasificaciones.Cuartos;
import clasificaciones.Finales;
import clasificaciones.Octavos;
import clasificaciones.Semis;
...
public class SeleccionarPartido extends javax.swing.JFrame implements ActionListener, MouseListener 
{
    ...
    private void listaComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listaComboActionPerformed
       ...
       if(listaCombo.getSelectedIndex() == 3) //Cuartos
       {
           Cuartos ope = new Cuartos(main);
           this.dispose();
               
       }
       if(listaCombo.getSelectedIndex() == 4) //Semi
       {
           Semis ope = new Semis(main);
           this.dispose();
               
       }
       if(listaCombo.getSelectedIndex() == 5) //Final
       {
           Finales ope = new Finales(main);
           this.dispose();
